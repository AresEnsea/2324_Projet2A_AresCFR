...
void STRATEGY_Init(void){
	...
	strategies[1].action_nb = 6;

	strategies[1].action[0].start_Time = 0;				//LIDAR SETUP
	...
	strategies[1].action[1].start_Time = 50;			// MOVE FORWARD
	...
	strategies[1].action[2].start_Time = 500;			// TURN RIGHT
	strategies[1].action[2].speed_Motor_Left = 10;
	strategies[1].action[2].speed_Motor_Right = 0;
	strategies[1].action[2].enable_stop_lidar = 1;

	strategies[1].action[3].start_Time = 1500;			// MOVE FORWARD W LIDAR
	strategies[1].action[3].speed_Motor_Left = 10;
	strategies[1].action[3].speed_Motor_Right = 10;
	strategies[1].action[3].enable_stop_lidar = 1;

	strategies[1].action[4].start_Time = 4500;			// CONTINUE SLOWER WITHOUT LIDAR
	strategies[1].action[4].speed_Motor_Left = 5;
	strategies[1].action[4].speed_Motor_Right = 5;
	strategies[1].action[4].enable_stop_lidar = 0;

	strategies[1].action[5].start_Time = 6000;			// STOP
	strategies[1].action[5].speed_Motor_Left = 0;
	strategies[1].action[5].speed_Motor_Right = 0;
	strategies[1].action[5].enable_stop_lidar = 0;
	...
	strategies[2].action[2].start_Time = 5000;			// TURN RIGHT
	strategies[2].action[2].speed_Motor_Left = 10;
	strategies[2].action[2].speed_Motor_Right = 0;
	strategies[2].action[2].enable_stop_lidar = 1;

	strategies[2].action[3].start_Time = 6500;			// MOVE FORWARD W LIDAR
	...
	strategies[2].action[4].start_Time = 8000;			// CONTINUE SLOWER WITHOUT LIDAR
	strategies[2].action[4].speed_Motor_Left = 5;
	strategies[2].action[4].speed_Motor_Right = 5;
	strategies[2].action[4].enable_stop_lidar = 0;

	strategies[2].action[5].start_Time = 9000;			// STOP
	strategies[2].action[5].speed_Motor_Left = 0;
	strategies[2].action[5].speed_Motor_Right = 0;
	strategies[2].action[5].enable_stop_lidar = 0;
